...
Pokémon and all associated character names, images, and trademarks are the intellectual property of Nintendo, Creatures Inc., and GAME FREAK inc.

No copyright infringement is intended. All assets and data related to the Pokémon franchise are used under Fair Use guidelines for transformative works.

This project is not affiliated with, endorsed by, or sponsored by Nintendo or The Pokémon Company.

---


## ✨ Features
* **Sort and Filter**: Multi-sort by stat / total, filter by type (AND / OR options)
* **Stat Insight**: Color-coded relative stat strength, highlight strongest stat(s) per pokemon 
* **Create Teams**: Create multiple 'Teams' 
